...
export const Hero: FC<HeroProps> = async (props) => {
    ...
    return (
        <div className={cn(className, 'relative h-[900px] pt-20 md:pt-24 xl:pt-28 2xl:pt-36')}>
            <Image
                src={bg}
                alt="hero"
                width={1440}
                height={900}
                className="absolute top-0 left-0 h-full max-h-[500px] w-full object-cover 2xl:max-h-[900px]"
            />
            <div className="relative z-10 container">
                <VStack gap="16" max className="md:text-left text-center">
