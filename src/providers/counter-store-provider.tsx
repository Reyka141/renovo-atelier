...
import { type CounterStore, createCounterStore, defaultInitState } from '../stores';
...
export const useCounterStore = <T,>(selector: (store: CounterStore) => T): T => {
    ...
    if (!counterStoreContext) {
        throw new Error(`useCounterStore должен использоваться внутри CounterStoreProvider`);
    }
